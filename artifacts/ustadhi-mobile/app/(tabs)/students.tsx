...
const styles = StyleSheet.create({
  ...
  screenTitle: {},
  countBadge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 14 },
  countText: {},
  searchRow: {
    flexDirection: 'row-reverse',
    alignItems: 'center',
  ...
  gradePill: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 10 },
  gradeText: {},
  coursesCount: {},
  inactiveBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  inactiveText: {},
