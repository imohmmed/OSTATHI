...
const styles = StyleSheet.create({
  ...
  screenTitle: {},
  addBtn: { flexDirection: 'row-reverse', alignItems: 'center', gap: 4, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 14 },
  ...
  courseFooter: { flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'space-between', marginHorizontal: 16, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 16, borderWidth: 1, borderTopWidth: 0, borderTopLeftRadius: 0, borderTopRightRadius: 0 },
  ...
  loginBtn: { marginTop: 8, paddingHorizontal: 36, paddingVertical: 14, borderRadius: 20 },
  emptyContainer: { alignItems: 'center', gap: 12, marginTop: 60 },
  createFirstBtn: { flexDirection: 'row-reverse', alignItems: 'center', gap: 6, paddingHorizontal: 20, paddingVertical: 12, borderRadius: 16 },
